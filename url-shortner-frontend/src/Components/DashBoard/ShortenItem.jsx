...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
  ...
  const fullUrl = `${import.meta.env.VITE_REACT_FRONT_END_URL}/u/${shortUrl}`;
      ...
      >
        <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
          <div className="text-slate-900 pb-1 sm:pb-0   flex items-center gap-2 ">
            ...
            <a
              ...
              className="text-[17px] font-montserrat font-[600] text-linkColor"
              href={`${import.meta.env.VITE_REACT_FRONT_END_URL}/u/${shortUrl}`}
            >
              {fullUrl.replace(/^https?:\/\//, "")}
            </a>
          </div>
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
          <div
            onClick={handleCopy}
            title="Click to copy"
            className={`flex items-center gap-2 px-5 py-2 rounded-md shadow-md transition-all duration-200 cursor-pointer
    ${
      isCopied
        ...
        : "bg-blue-600 hover:bg-blue-700"
          ...
          >
            ...
            {isCopied ? (
              <LiaCheckSolid className="text-white text-lg" />
            ) : (
